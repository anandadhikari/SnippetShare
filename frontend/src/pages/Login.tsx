...
const Login = ({ setMode }: Prop) => {
    ...
    const schema = yup.object({
        ...
        password: yup
            ...
            .matches(/^(?=.*[A-Za-z])(?=.*\d{4})[A-Za-z\d]+$/, "Password must include at least 4 numbers")
        ...
        try {
            ...
            await api.post("/api/auth/login", credentials)
                ...
                .catch((error) => {
                    setCustomAlert({
                        ...
                        show: true,
                        variant: 'danger',
                        link: "https://snippetfrontend.onrender.com/login",
                        linkText: "Login"
                    })
                })
            ...
            if (error.message === "Network Error") {
                ...
                setCustomAlert({
                    ...
                    show: true,
                    variant: 'danger',
                    link: "https://snippetfrontend.onrender.com/",
                    linkText: "Home"
                })
                setShow(true)
